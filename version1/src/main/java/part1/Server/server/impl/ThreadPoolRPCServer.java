...
public class ThreadPoolRPCServer implements RpcServer {
    ...
    //自定义构造方法、
    public ThreadPoolRPCServer(ServiceProvider serviceProvider, int maxCorePoolSize,
                               int maxPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue){
